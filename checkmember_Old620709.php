...
$sql = "SELECT * FROM roster where seminar = 'sfst' ";
...
<form method="POST" name="form1" id="form1" class="cd-form floating-labels floating-label-other">
        ...
        <div>
           ...
           <legend>วันจันทรที่ 11 กุมภาพันธ์ 2562 ณ โรงแรมแคนทารี โคราช จังหวัดนครราชสีมา<br><br>สถาบันวิจัยวิทยาศาสตร์และเทคโนโลยีแห่งประเทศไทย (วว.)</legend>
		   ...
		   <button type="button" class="btn btn-basic" onclick="Regis()"><span class="glyphicon glyphicon-user"></span>Admin วันที่ 27</button>
