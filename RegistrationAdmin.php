...
<form action="insertAdmin.php" method="POST" name="form1" id="form1" class="cd-form floating-labels floating-label-other">
<!--form action="#" method="POST" name="form1" id="form1" class="cd-form floating-labels floating-label-other"-->
		...
		<fieldset class="border">
            <div>
            <div class="legend2">Registration Form (Extra) </div>
            <legend><font color="red"> โครงการสัมมนา การขับเคลื่อนระบบโลจิสติกส์ ด้วยวิทยาศาสตร์และเทคโนโลยีแบบ New Normal</font><br>
           <font color="red">วันอังคารที่ 22 กันยายน 2563  เวลา 08.30 - 13.30 น.</font> <br><br>ณ โรงแรมเดอะ เบอร์เคลีย์ โฮเต็ล ประตูน้ำ กรุงเทพฯ<br><br>Thailand Institute of Scientific and Technological Research (TISTR)</legend>
			<!--a href="index.php"><input class="button5" type="button" value="Home"></a-->
			<div class="row">
				<!--div class="col-md-2"-->
						<a href="checkmember.php" class="btn btn-primary" ><center>Home</center></a>
				<!--/div-->
				<!--div class="col-md-3"-->
