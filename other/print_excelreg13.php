...
$strExcelFileName = "FoodIndustry2017-13".".xls";
...
include '../Connections/registration.php'; 
$sql = "SELECT * FROM roster where seminar='Food' and (datein='13' or datein='12-13') ORDER BY arrived DESC ";
...
<body>
        <strong>รายงานชื่อผู้เข้าร่วมงาน FoodIndustry 13 มิถุนายน 2560</strong><br><br>
