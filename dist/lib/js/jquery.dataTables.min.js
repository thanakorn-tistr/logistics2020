...
oPaginate:{sFirst:"หน้าแรก",sLast:"หน้าสุดท้าย",sNext:"ถัดไป",sPrevious:"ก่อนหน้า"},sEmptyTable:"ไม่มีข้อมูลในตาราง",sInfo:"แสดงผล _START_ ถึง _END_ จากทั้งหมด _TOTAL_ ข้อมูล",sInfoEmpty:"แสดงผล 0 ถึง 0 จากทั้งหมด 0 ข้อมูล",sInfoFiltered:"(ค้นหาจากทั้งหมด _MAX_ ข้อมูล)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"แสดง _MENU_ ข้อมูล",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"ค้นหา :",sSearchPlaceholder:"ค้นหา ...",sUrl:"",sZeroRecords:"ไม่พบข้อมูลที่ค้นหา"},oSearch:h.extend({},
