<?php
 ...
 $strSQL = "select * from tb_training where training_status = 'Public'";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="datatable table table-striped" cellspacing="0" width="100%" >
                                            ...
                                            <?php
                                                ...
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo $objResult["training_date"]; ?></td>
                                                    <td><?php echo $objResult["training_day"]; ?></td>
                                                    <td><?php echo "<b>".$objResult["training_code"]."</b>"; ?></td>
                                                    <td><a href="#"><?php echo $objResult["training_name"]; ?></a></td>
                                                    <td><?php echo $objResult["training_pay"]; ?></td>
                                                    <td><?php echo $objResult["training_dept"]; ?></td>
                                                    <td><div class="col-lg-6"><i class="fa fa-file-pdf-o"></i>
                                                        </div><div class="col-lg-6"><i class="fa fa-file-video-o"></i></div></td>
                                                    <td><div class="col-lg-6"><i class="fa fa-shopping-cart"></i>
                                                        </div><div class="col-lg-6"><i class="fa fa-envelope-o"></i></div></td>
                                        ...
                                        <ul class="message-list">
                                            ...
                                            <a href="inhouse.php">
                                                <li>
                                                    ...
                                                    <div class="card-body half-padding">
                                                        <h5 class="no-margin font-weight-300" >
                                                            <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> In-house Training</h5>
                                                        <div class="clear-both"></div>
                                                    </div>
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-title">
                                            <div class="title">ความหมายของไอคอน</div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <ul class="message-list">
                                            <div class="col-lg-4">
                                                <h5>
                                                    <i class="fa fa-file-pdf-o"></i> เอกสารหลักสูตร (ไฟล์ PDF)<br><br>
                                                    <i class="fa fa-cart-plus"></i> เปิดการจองอบรมออนไลน์ตามปกติ<br><br>
                                                    <i class="fa fa-envelope-o"></i> เปิดการจองอบรมทางเมลล์ตามปกติ
                                                </h5>
                                            </div>
                                            <div class="col-lg-4">
                                                <h5>
                                                    <i class="fa fa-file-video-o"></i> วิดีโอแนะนำหลักสูตร<br><br>
                                                    <i class="fa fa-shopping-cart"></i> ปิดการจองอบรมออนไลน์ในหน้าเว็บแล้ว<br><br>
                                                    <i class="fa fa-envelope"></i> ปิดการจองอบรมทางเมลล์ในหน้าเว็บแล้ว
                                                </h5>
                                            </div>
                                            <div class="col-lg-4">
                                                <h5>
                                                    <i class="fa fa-file"></i> ไม่มีวิดีโอแนะนำหลักสูตร<br><br>
                                                    <i class="fa fa-signal"></i> หลักสูตรจองเต็มแล้ว<br><br>
                                                    <i class="fa fa-user-plus"></i> หลักสูตรจองเต็มแล้ว (สามารถสำรองได้)
                                                </h5>
                                            </div>
